  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        colList = $('<paper-shadow z="1"></paper-shadow>').addClass('pvtAxisContainer pvtUnused');
        ...
        fn = function(c) {
          ...
          triangleLink = $("<span>").addClass('pvtTriangle').append('<iron-icon icon="icons:expand-more">').bind("click", showFilterList);
          attrElem = $("<li>").addClass("axis_" + i)
          .append($('<span>')
            .addClass('pvtAttr')
            .text(c).data("attrName", c).append(triangleLink));
        ...
        tr1 = $('<div style="clear:both">').appendTo(uiTable);
        ...
        $('<paper-shadow z="1"></paper-shadow>').addClass('pvtVals')
          .appendTo(tr1).append(aggregator).append($("<br>"));
        
        $('<paper-shadow z="1"></paper-shadow>').addClass('pvtAxisContainer pvtHorizList pvtCols').appendTo(tr1);
        tr2 = $('<div style="clear:both">').appendTo(uiTable);
        tr2.append($('<paper-shadow z="1"></paper-shadow>').addClass('pvtAxisContainer pvtRows').attr("valign", "top"));
        pivotTable = $("<div>").attr("valign", "top").addClass('pvtRendererArea').appendTo(tr2);
        if (opts.unusedAttrsVertical === true || unusedAttrsVerticalAutoOverride) {
          uiTable.find('tr:nth-child(1)').prepend(rendererControl);
          uiTable.find('tr:nth-child(2)').prepend(colList);
        } else {
          uiTable.prepend($("<div>").append(rendererControl).append(colList));
        }
        this.html(uiTable);
        ref3 = opts.cols;
